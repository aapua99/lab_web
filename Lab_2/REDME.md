...
Далі встановимо бібліотеку express, за допомогою команди: npm install express Інші пакети вже містяться у проекті.

Запуск

В командній строці заходимо у корінь-папку нашого проекту. Тоді просто вводимо: npm start
